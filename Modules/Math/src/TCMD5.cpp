...
//*******************************************************************************
//  $Id: TCMD5.cpp,v c0056a2f47c7 2012/07/03 21:05:30 thomas $
//*******************************************************************************
 ...
 */
void MD5Init(MD5Context * md5_context)
{
   md5_context->total[0] = md5_context->total[1] = 0;
...
/* The routine MD5Final terminates the message-digest computation and
   ends with the desired message digest in md5_context->digest[0...15].
 */
...
std::string MD5::GetHashString() const
{
...
std::string MD5::GetHashDigets() const
{
   MD5Final(md5_context);

   char hash_string[17];
   std::memcpy(hash_string, md5_context->digest, 16);
   hash_string[16] = 0;
