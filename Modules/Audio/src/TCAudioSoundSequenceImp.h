...
//*******************************************************************************
//  $Id: TCAudioSoundSequenceImp.h,v c0056a2f47c7 2012/07/03 21:05:30 thomas $
//*******************************************************************************
#ifndef _TC_AUDIO_SOUND_SEQUENCE_IMP_H_
#define _TC_AUDIO_SOUND_SEQUENCE_IMP_H_
...
namespace tc
{
   namespace audio
   {
      ...
      */
      class TC_DLL_LOCAL SoundSequenceImp: public SoundCompound
      {  
      public:
         SoundSequenceImp(SoundDataSequencePtr sound_data, 
                          SoundPlayerPtr sound_player,
                          SoundDataMapperPtr sound_data_mapper);
         virtual ~SoundSequenceImp();
      ...
      private:
        SoundDataSequencePtr m_sound_data;
        SoundPlayerPtr m_sound_player;
        SoundDataMapperPtr m_sound_data_mapper;
      };
   }
}
#endif // _TC_AUDIO_SOUND_SEQUENCE_IMP_H_
