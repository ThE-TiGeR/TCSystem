...
elseif (WIN32)
   ...
   set (TC_COMPILE_CFLAGS         "${TC_COMPILE_CFLAGS} /DHAVE_UNIT_TESTS /EHsc /W4 /D_WIN32_WINNT=0x0602 /D_SCL_SECURE_NO_WARNINGS /D_CRT_SECURE_NO_WARNINGS /Gm- /MP")
   set (TC_COMPILE_FLAGS_DEBUG   "/DDEBUG /FR")
   set (TC_COMPILE_FLAGS_RELEASE "/DNDEBUG /Ox /Ob2 /Ot /Oi /GL /GS- /arch:AVX /fp:fast /D_SECURE_SCL=0")
