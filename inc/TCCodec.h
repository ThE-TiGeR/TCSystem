...
//*******************************************************************************
//  $Id: TCCodec.h 957 2010-01-28 23:17:00Z the_____tiger $
//*******************************************************************************
#ifndef _TCCODEC_H_
#define _TCCODEC_H_
...
namespace TC
{
    ...
    public:
       ...
       * @return Number of bytes decoded
       */
       virtual uint32 Decode(Stream& stream, std::wstring& val) = 0;
       /**
       ...
       */
        ...
        * @return Number of bytes encoded
        */
       virtual uint32 Encode(const std::wstring& val, Stream& stream) = 0;
       /**
